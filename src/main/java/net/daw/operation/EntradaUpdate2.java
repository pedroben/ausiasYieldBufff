    ...
    public Object execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        switch (oContexto.getSearchingFor()) {
            ...
            default:
                ...
                String strMensaje = "Se ha cambiado la información de compra con id=" + Integer.toString(oEntradaBean.getId()) + "<br />";
                strMensaje += "<a href=\"Controller?class=entrada&method=list&filter=id_usuario&filteroperator=equals&filtervalue=" + oEntradaBean.getUsuario().getId() + "\">Ver entrada de este usuario</a><br />";
